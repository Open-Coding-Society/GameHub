...
description: Outbreak, Adventure, Exploration
permalink: /world2
...
// --- Background Music ---
const music = new Audio('{{site.baseurl}}/assets/audio/everybodyfalls.mp3'); // Change path as needed
music.loop = true;
music.volume = 0.5;
...
roomImage.src = '{{site.baseurl}}/images/worldbackground2.png';
