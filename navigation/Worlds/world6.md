...
layout: post
title: Strategy Core
description: Strategy, Simulation, Tower
permalink: /world6
...
// --- Background Music ---
const music = new Audio('{{site.baseurl}}/assets/audio/terrariaday.mp3'); // Change path as needed
music.loop = true;
music.volume = 0.5;
...
roomImage.src = '{{site.baseurl}}/images/worldbackground6.png';
