...
// --- Background Music ---
const music = new Audio('{{site.baseurl}}/assets/audio/hopesanddreams.mp3'); // Change path as needed
music.loop = true;
music.volume = 0.5;
...
roomImage.src = '{{site.baseurl}}/images/worldbackground4.png';
...
const objects = [
  { x: 215, y: 400, width: 40, height: 40, game: 'party' }, // top 2
  { x: 455, y: 225, width: 40, height: 40, game: 'slot' }, // top 5
  { x: 700, y: 420, width: 40, height: 40, game: 'pack' } // middle 2
  ];
